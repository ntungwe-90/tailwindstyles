  ...
  <nav class="relative flex flex-wrap items-center justify-between px-2 py-3 bg-white-500 mb-3">
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
      <div class="w-full relative flex justify-between lg:w-auto  px-4 lg:static lg:block lg:justify-start ">
        <a class="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-black" href="#pablo">
          pink Color
        </a>
      ...
      <div v-bind:class="{'hidden': !showMenu, 'flex': showMenu}" class="lg:flex lg:flex-grow items-center hover:text-yellow-500">
        <ul class="flex flex-col lg:flex-row list-none ml-auto">
          <li class="nav-item">
            <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75" href="#pablo">
              <i class="fab fa-facebook-square text-lg leading-lg text-white opacity-75" /><span class="ml-2">our company</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75" href="#pablo">
              <i class="fab fa-twitter text-lg leading-lg text-white opacity-75" /><span class="ml-2">services</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75" href="#pablo">
              <i class="fab fa-pinterest text-lg leading-lg text-white opacity-75" /><span class="ml-2">solution<svg width="7" height="6" viewBox="0 0 7 6" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline" data-v-60d2372e=""><path d="M3.14176 5.18019C3.16922 5.22007 3.20596 5.25268 3.24881 5.2752C3.29167 5.29773 3.33936 5.3095 3.38778 5.3095C3.43619 5.3095 3.48388 5.29773 3.52674 5.2752C3.5696 5.25268 3.60634 5.22007 3.6338 5.18019L6.32741 1.28941C6.35859 1.24454 6.37688 1.19197 6.38028 1.13743C6.38368 1.0829 6.37207 1.02847 6.34671 0.980063C6.32136 0.931659 6.28322 0.89113 6.23644 0.86288C6.18966 0.83463 6.13604 0.819739 6.0814 0.819825H0.694159C0.639641 0.82005 0.586216 0.835132 0.539629 0.86345C0.493042 0.891768 0.455056 0.93225 0.429756 0.980542C0.404455 1.02883 0.392798 1.08311 0.396038 1.13753C0.399277 1.19195 0.417291 1.24446 0.448142 1.28941L3.14176 5.18019Z" fill="black" data-v-60d2372e=""></path></svg></span>
            </a>
            <ul class="_dropdown_list hidden bg-white shadow-md w-64 py-5 rounded" data-v-60d2372e=""><li class="flex justify-center items-center" data-v-60d2372e=""><a href="/wa-insight" data-v-60d2372e="" class=""><img src="/images/walulel-wainsight.png" alt="Walulel - wa-insight.com" data-v-60d2372e=""></a></li> <li class="flex justify-center items-center" data-v-60d2372e=""><a href="/wa-communicate" data-v-60d2372e="" class=""><img src="/images/walulel-wacommunicate.png" alt="Walulel - wa-communicate.com" data-v-60d2372e=""></a></li> <li class="flex justify-center items-center" data-v-60d2372e=""><a href="/wa-patron" data-v-60d2372e="" class=""><img src="/images/walulel-wapatron.png" alt="Walulel - wa-patron.com" data-v-60d2372e=""></a></li> <li class="flex justify-center items-center" data-v-60d2372e=""><a href="/wa-artisan" data-v-60d2372e="" class="nuxt-link-exact-active nuxt-link-active" aria-current="page"><img src="/images/walulel-waartisan.png" alt="Walulel - wa-artisan.com" data-v-60d2372e=""></a></li></ul>
          </li>
        </ul>
        
      </div>
      <button class="bg text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
      >
  contact us
</button>
    </div>
  </nav>
  <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-pink-600 bg-pink-200  last:mr-0 mr-1">
  navbar component
</span>

  <!-- border radius with an image  -->
...
<button class="text-pink-500 border border-pink-500 hover:bg-pink-500 hover:text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
      >
  <i class="fas fa-heart"></i> Regular
</button>

<button class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-base px-8 py-3 rounded-full shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
      >
  <i class="fas fa-heart"></i> contact us for more information
</button>
</div>
